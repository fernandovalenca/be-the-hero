    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.backButton} hitSlop={{ top: 20, bottom: 20, right: 30, left: 30 }} onPress={navigateToIncident}>
                    <Ionicons name='ios-arrow-back' size={28} color='#E02041' />
                </TouchableOpacity>
